...
<div class="content delete">
    ...
    <p><?=$msg?></p>
    <?php else: ?>
	<p>Are you sure you want to delete Image # <?=$image['id']?>?</p>
    <div class="yesno">
        <a href="delete_gallery.php?id=<?=$image['id']?>&confirm=yes">Yes</a>
        <a href="delete_gellery.php?id=<?=$image['id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
