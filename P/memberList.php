	  ...
	  <li class="nav-item">
		...
		<div class="panel panel-primary">
			<div class="panel-heading" >
				<h2 style="text-align: center; padding: 10px">Thông tin thành viên</h2>
				<div class="row">
					<div class="col-lg-6">
						<form method="GET">
			...
			<div class="panel-body">
				<table class="table table-bordered">
					...
					<tbody>
						...
						$sql      = "select * from member where 1 $addition limit $firstIndex,$limit";
						$memberList = executeResult($sql);	

						$sql = "select count(id) as total from member where 1 $addition";	
